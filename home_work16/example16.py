'''Написать скрипт, который из следуюйщей категории спарсит информацию о продуктах и сохранит данные в excel файл.
Нужно спарсить 10 страниц. Нужны следующие данные: название компьютера, цена со скидкой, время выгрузки.'''
